...
const Item = ({image,name,price,brand}) => {
  return (
    <div className=' flex flex-col items-center rounded-md w-[300px] shadow-md'>
        ...
        <div className=' flex flex-col justify-center items-center gap-y-1 my-5'>
            ...
            <button className=' text-xl font-[400] px-3 py-2 bg-amber-300 rounded-md hover:bg-amber-400  '>Add to cart</button>
        </div>
    </div>
  )
}
